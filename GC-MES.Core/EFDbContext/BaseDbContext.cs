...
namespace GC_MES.Core.EFDbContext
{
    public abstract class BaseDbContext : DbContext
    {
        ...
        protected void OnModelCreating(ModelBuilder modelBuilder, Type type)
        {
            ...
            catch (Exception ex)
            {
                ...
                GC_MES.Core.Utilities.FileHelper.WriteFile(mapPath, $"syslog_{DateTime.Now.ToString("yyyyMMddHHmmss")}.txt", ex.Message + ex.StackTrace + ex.Source);
            }
